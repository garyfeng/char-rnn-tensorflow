...
class Model():
    ...
    # garyfeng: calc the likelihood of a string given the model
    #  text is the text to evaluate
    # returns 2 vectors [chars, prob.]
    def loglikelihood(self, sess, chars, vocab, text='The '):
        state = self.cell.zero_state(1, tf.float32).eval()
